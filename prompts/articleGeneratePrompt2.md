...
* Ask a question the reader is qualified to answer: Not "what do you think?" but a question that taps their expertise. "Where in your workflow does the 80% feel like enough — and where does the last 18% actually matter?" The reader should feel like they have something worth saying.
* Leave a gap the reader wants to fill: Make a claim that's deliberately incomplete or provocative enough that people with experience will want to add their version, push back, or share a counterexample. The technique is to state a pattern confidently but stop short of claiming it's universal — "In every implementation I've seen, the bottleneck was never the AI. I'm curious if anyone's had the opposite experience." The confidence invites pushback; the curiosity gives permission to disagree.
...
# Writing Style
Tone:
- Informative, conversational, jovial, helpful
- Personal and personable, never attention-seeking or excitement-riling
- NOT salesy, NOT promotional, NOT boastful
...
Word choice — AVOID:
- Intensifiers, degree modifiers, boosters: "profound," "astonishing," "amazing," "intense," "incredible," "game-changer," "unprecedented"
- Corporate jargon: "leverage," "synergy," "unlock," "drive," "elevate"
...
# Rules
- All 3 versions must argue the same angle. They differ in emotional approach and structure, not in thesis.
- Do not fabricate examples, client names, anecdotes, or data points. Only use what is present in the raw material or background context. If a version would benefit from a concrete example you don't have, use an [EXAMPLE SLOT] marker instead.
- Do not cap length. Be effusive and rich at this stage. Later steps will compress.
